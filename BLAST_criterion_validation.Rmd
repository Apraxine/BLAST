...
model.wpen.01 <- glm(MEDIAN_RT_F30_1 ~ Age*Gender*SubType,
                  data = AllData,
                  family = Gamma())

model.wpen.02 <- glm(MEDIAN_RT_F30_1 ~ Age*Gender*SubType,
                  data = AllData,
                  family = Gamma(link = "log"))

model.wpen.03 <- glm(MEDIAN_RT_F30_1 ~ Age*Gender*SubType,
                  data = AllData,
                  family = gaussian())


model.wpen.04 <- glm(MEDIAN_RT_F30_1 ~ Age*Gender*SubType,
                  data = AllData,
                  family = gaussian(link = "log"))
...
<p style="color:SteelBlue"><strong>HSD Post-hoc analysis indicates that the ADD group of patients exhibit similar Median RT to the task. Additionally, both the ADD and ADD-HI participants were slower to respond to target in comparison to participants from the Control group.</strong></p> 
