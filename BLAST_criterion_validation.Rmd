...
GraphSave_path     = "C:/Users/Roxane Hoyer/Desktop/R/R_STABILO/GitHub/STABILO_criterion_validation/graph/"
...
AllData %>%
  ...
  # scale_y_continuous(breaks=seq(0, 35, by=5))+
    labs(
    title = "Sample by age for each group of participant",  
    x     = "Age", 
    y     = "Number")+
...
Irrespective of the SUBJECT TYPE, participants are becoming faster to answer the target with increasing age. 
```{r, message=FALSE, warning=FALSE, echo=FALSE, fig.align="center"}
...
HSD Post-hoc analysis indicates that both of the patient groups exhibit similar Median RT to the task. Additionally, both ADD and ADD-HI participants were slower to respond to target in comparison to participants from Control group. 
...
AllData %>%
  ...
  theme(
    ...
    strip.background = element_rect(colour="gray94", fill="gray94"))+
 labs(
    title = "Median RT distribution by group ", 
